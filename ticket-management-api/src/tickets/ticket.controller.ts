  ...
  @ApiResponse({
    ...
    schema: {
      ...
      properties: {
        ...
        topicId: { type: 'number', nullable: true, example: 1 },
        topic: {
          type: 'object',
          nullable: true,
          properties: {
        ...
        topicName: { type: 'string', example: 'Bug Report', description: 'Topic name (from topic.name or topicNameSnapshot if topic is deleted)' },
